...
export default function TopNewsSidebar({ data, className }: TopNewsSidebarProps) {
    return (
                ...
                {data.map((news) => (
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 w-full p-3 z-10 flex flex-col gap-0.5">
                            ...
                            <h4 className="lg:text-sm font-bold text-white line-clamp-2 lg:line-clamp-1 leading-tight group-hover:text-red-400 transition-colors">
                                {news.title}
                            </h4>
